...
for (const id of ['patch-job', 'quarry', 'aftershock', 'longwall', 'staircase', 'highwater']) seeded.best[id] = best(2000);
...
eq(progress(), 'Sixteen valleys. One rising river.',
...
eq(progress(), 'Sixteen valleys. One rising river.', 'a fresh save shows the tagline, not "0 of 10"');
